                ...
                <div style="margin-top: 60px">
                    ...
                    <div class="col-sm-9">
                        <div class="col-sm-12">
                            ...
                            @endif
                            <form class="form-horizontal" method="POST" action="{{url('job-post/new-job-post')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="job_designation" class="form-control" id="inputEmail3" placeholder="Job designation">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="vacancey" class="form-control" id="inputEmail3" placeholder="No of Vacancies">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea name="job_descripton" class="form-control" rows="6"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="job_location" class="form-control" id="inputEmail3" placeholder="Job Loacation">
