        ...
        <div class="container">
            <div class="row header_specl_class">
                ...
                <div class="navbar-header navbar_logo" style="display: inline;">
                    <!--<a href="/" style="float: left; margin-right: 5PX;"><img src="images/logo.png" height="50px" width="150px" alt="Chakri" class="header_logo" data-pagespeed-no-transform /></a>-->
...
{{--{{url('job-post/add-job-post')}}--}}
{{--onClick="_gaq.push(['_trackEvent', 'ButtonClick', 'Register', '/job?indId=1', , true]);"--}}
<div class="container">
