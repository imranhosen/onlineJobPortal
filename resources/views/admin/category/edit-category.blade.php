            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Edit Job Category<small></small></h2>
                            ...
                            <div class="x_content">
                                <br />
                                <form id="editCategoryForm" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{url('/category/update-category')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="category_name" value="{{$categoryInfoById->category_name}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control" rows="6" name="category_description">{{$categoryInfoById->category_description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
